...
#![doc = " Structs that treat the modular arithmetic."]
#![doc = ""]
...
#![doc = ""]
#![doc = " input! {"]
#![doc = "     from OnceSource::from(\"1000000006 2\\n\"),"]
#![doc = "     a: Mint,"]
#![doc = "     b: Mint,"]
#![doc = " }"]
#![doc = ""]
...
#![doc = ""]
#![doc = " input! {"]
#![doc = "     from OnceSource::from(\"3 3 7\\n\"),"]
#![doc = "     a: u32,"]
#![doc = "     b: u32,"]
#![doc = "     m: u32,"]
#![doc = " }"]
#![doc = ""]
#![doc = " Mint::set_modulus(m);"]
#![doc = " let a = Mint::new(a);"]
#![doc = " let b = Mint::new(b);"]
#![doc = ""]
#![doc = " println!(\"{}\", a * b); // `2`"]
#![doc = " ```"]
#![doc = ""]
#![doc = " # Major changes from the original ACL"]
#![doc = ""]
#![doc = " - Converted the struct names to PascalCase."]
#![doc = " - Renamed `mod` → `modulus`."]
#![doc = " - Moduli are `u32`, not `i32`."]
#![doc = " - Each `Id` does not have a identifier number. Instead, they explicitly own `&'static LocalKey<RefCell<Barrett>>`."]
#![doc = " - The type of the argument of `pow` is `u64`, not `i64`."]
#![doc = " - Modints implement `FromStr` and `Display`. Modints in the original ACL don't have `operator<<` or `operator>>`."]
#![doc = ""]
#![doc = " [`ModInt1000000007`]: ./type.ModInt1000000007.html"]
#![doc = " [`ModInt998244353`]: ./type.ModInt998244353.html"]
#![doc = " [`ModInt`]: ./type.ModInt.html"]
